...
import { prisma, initPrismaDatabase, seedPrismaData } from './prismaDb';
import {
  authenticateToken,
  requireRole,
  hashPassword,
...
// Initialize JSON parser & URL encoded parser
...
apiRouter.get('/auth/users', authenticateToken, requireRole('ADMIN'), async (req: AuthenticatedRequest, res: Response) => {
  try {
...
apiRouter.post('/auth/users', authenticateToken, requireRole('ADMIN'), async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { email, password, name, phone, role } = req.body;
...
// Admin: Delete User
apiRouter.delete('/auth/users/:id', authenticateToken, requireRole('ADMIN'), async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
apiRouter.post('/categories', authenticateToken, requireRole('ADMIN'), async (req: AuthenticatedRequest, res: Response) => {
  try {
...
apiRouter.put('/categories/:id', authenticateToken, requireRole('ADMIN'), async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
apiRouter.post('/products', authenticateToken, requireRole('ADMIN'), async (req: AuthenticatedRequest, res: Response) => {
  try {
    const {
...
apiRouter.put('/products/:id', authenticateToken, requireRole('ADMIN'), async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
    const {
...
// ==========================================
apiRouter.get('/orders', authenticateToken, requireRole('ADMIN'), async (req: AuthenticatedRequest, res: Response) => {
  try {
...
apiRouter.patch('/orders/:id', authenticateToken, requireRole('ADMIN'), async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
apiRouter.delete('/orders/:id', authenticateToken, requireRole('ADMIN'), async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
apiRouter.post('/seed', authenticateToken, requireRole('ADMIN'), async (req: AuthenticatedRequest, res: Response) => {
  try {
...
// Mount router on BOTH `/api` and `/` so all deployment environments match seamlessly
